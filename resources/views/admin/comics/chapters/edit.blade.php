                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('admin.comics.chapters.update', $chapter->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <img src="@if (!$chapter->comic->img_path) {{ asset('storage/images/sancomics_cover.png') }} @else {{ asset('storage/'.$chapter->comic->img_path) }} @endif" class="img-fluid img-cover mb-2">
                                </div>
                            </div>
                            <div class="form-group row">
